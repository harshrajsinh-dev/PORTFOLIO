...
//     SiVercel,
//     SiGooglecloud,
//     SiCplusplus, SiJavascript, SiNextdotjs, SiNodedotjs, SiReact
// } from "react-icons/si";

// const stack = [
//     { icon: SiJavascript, name: "JavaScript", field: "Frontend" },
//     { icon: SiReact, name: "React.js", field: "Frontend" },
//     { icon: SiNodedotjs, name: "Node.js", field: "Backend" },
//     { icon: SiHtml5, name: "HTML", field: "Frontend" },
//     { icon: SiCss3, name: "CSS", field: "Frontend" },
//     { icon: SiTailwindcss, name: "Tailwind CSS", field: "Frontend" },
//     { icon: SiGit, name: "Git", field: "others" },
//     { icon: SiGithub, name: "GitHub", field: "others" },
//     { icon: SiExpress, name: "Express.js", field: "Backend" },
//     { icon: SiMongodb, name: "MongoDB", field: "Backend" },
//     { icon: SiMysql, name: "MySQL", field: "Backend" },
//     { icon: SiVercel, name: "Vercel", field: "others" },
//     { icon: SiCplusplus, name: "C++ / C", field: "others" },
// ];
